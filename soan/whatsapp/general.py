...
def plot_messages(df, colors=None, trendline=False, savefig=False, dpi=100):
    ...
    font = {'fontname': 'Montserrat', 'fontsize': 14}
    ax.set_ylabel('Nr of Messages', font)
...
def calendar_plot(data, year=None, how='count', column='User', savefig=False, dpi=100):
    ...
    * Set date as index
    ...
    font = {'fontname': 'Montserrat', 'fontsize': 20}
    ax.set_xlabel('')
    ...
    font = {'fontname': 'Montserrat', 'fontsize': 15}
    ax.set_ylabel('')
